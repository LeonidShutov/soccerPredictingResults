...
def run():
    ...
    fifa_data = ExtractData.get_fifa_data(match_data, player_stats_data, data_exists=False)
    # Creating features and labels based on data provided
    bk_cols_selected = ['B365', 'BW']
    feables = ExtractData.create_feables(match_data, fifa_data, bk_cols_selected, get_overall=True)
